...
// Added IR.IN token, so total token count must be incremented.
#define N_TOKEN 133
#define TOKEN_NULL 0
#define TOKEN_VAR 1
...
#define TOKEN_CHR 131
#define TOKEN_STR 132
#define TOKEN_DEC 133
#define TOKEN_HEX 134
#define TOKEN_BIN 135
